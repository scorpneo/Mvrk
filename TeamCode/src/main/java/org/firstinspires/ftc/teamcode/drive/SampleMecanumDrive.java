...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(0.14, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0.32, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.448;
